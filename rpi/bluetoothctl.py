...
class Bluetoothctl:
    ...
    def send(self, command, pause=0):
        ...
        if self.process.expect(["bluetooth", pexpect.EOF]):
            raise Exception("failed after" +  command)
    ...
    def remove(self, mac_address):
        ...
        try:
            self.send("remove" + mac_address, 3)
        except Exception as e:
            logger.error(e)
            return False
        else:
    ...
    def connect(self, mac_address):
        ...
        try:
            self.send("connect" + mac_address, 2)
        except Exception as e:
            logger.error(e)
            return False
        else:
    ...
    def disconnect(self, mac_address):
        ...
        try:
            self.send("disconnect" + mac_address, 2)
        except Exception as e:
            logger.error(e)
            return False
        else:
